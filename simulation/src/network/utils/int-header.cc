...
const uint64_t IntHop::lineRateValues[8] = {12500000000lu, 25000000000lu,50000000000lu,75000000000lu,100000000000lu,200000000000lu,400000000000lu,800000000000lu};
...
uint32_t IntHeader::GetStaticSize(){
	if (mode == NORMAL){
		...
		return sizeof(ts) + sizeof(hop) + sizeof(nhop);
	}else {
		return 0;
	}
}
